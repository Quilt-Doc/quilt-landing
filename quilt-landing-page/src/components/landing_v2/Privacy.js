    ...
    render(){
        return(
                <PolicyCard>
                    ...
                    <LI>
                    <P><Strong>Company</Strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Quilt.</P>
                    </LI>
                    <LI>
                    ...
                    <LI>
                    <P><Strong>Website</Strong> refers to Quilt, accessible from <a href="https://getquilt.app" rel="external nofollow noopener" target="_blank">https://getquilt.app</a></P>
                    </LI>
                    <LI>
                    ...
                    <UL>
                    <LI>By email: karan@getquilt.app</LI>
                    </UL>
                </PolicyCard>
        )
    }
...
const PolicyCard = styled.div`
    box-shadow: 0 .4375rem 1rem rgba(106,111,130,.11)!important;
...
const H1 = styled.h1`
    ...
    margin-block-end: box-sizing border-box;
    color: rgb(70, 72, 85);
    display: block;
    font-size: 26px;
    font-weight: 700;
    ...
    text-align: left;
    text-size-adjust: 100%;
    -webkit-tap-highlight-color: rgba(0, 0, 0, 0)0.67em;
    margin-inline-start: 0px;
    margin-inline-end: 0px;
    font-weight: bold;
`;
